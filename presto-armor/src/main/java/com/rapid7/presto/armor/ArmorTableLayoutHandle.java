...
public class ArmorTableLayoutHandle
        implements ConnectorTableLayoutHandle
{
    private final ArmorTableHandle table;
    private final TupleDomain<ColumnHandle> tupleDomain;

    @JsonCreator
    public ArmorTableLayoutHandle(
            @JsonProperty("table") ArmorTableHandle table,
    ...
    @JsonProperty
    public ArmorTableHandle getTable()
    {
        return table;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        ArmorTableLayoutHandle that = (ArmorTableLayoutHandle) o;
